...
public class TiConArrowMaterialConfigHandler extends ConfigHandler {
	...
	public static final TiConArrowMaterialConfigHandler INSTANCE = new TiConArrowMaterialConfigHandler(new File("./config/SquidUtils/compat/TiCon/ArrowMaterials.cfg"));
